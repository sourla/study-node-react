  ...
  return (
      <main>
        ...
        <div className="mb-8 flex items-center gap-3 rounded-xl border border-cyan-400/20 bg-cyan-400/5 px-4 py-3 text-sm">
          <span className="rounded-full bg-cyan-400 px-2 py-0.5 text-xs font-bold text-zinc-950">1</span>
          <span className="text-white">목록</span><span className="text-zinc-500">→</span>
          <span className="rounded-full border border-cyan-400/50 px-2 py-0.5 text-xs font-bold text-cyan-300">2</span>
